...
public class ImageLoader {
	...
	private static final ModelCache<GlideUrl> urlCache = new ModelCache<GlideUrl>(
			150);
	 ...
	 */
	public void loadImage(String url, ImageView imageView,
			RequestListener<String> requestListener, Drawable placholderOverride) {
	...
	public void loadImage(String url, ImageView imageView,
		...
		BitmapRequestBuilder request = beginImageLoad(url, requestListener,
				crop).animate(R.anim.image_fade_in);
	...
	public BitmapRequestBuilder beginImageLoad(String url,
		...
		return mGlideModelRequest.load(url).asBitmap()
