...
import static com.ruiqi.product.singhome.util.LogUtils.LOGE;

public class UIUtils {
	private static final String TAG = makeLogTag(UIUtils.class);

	public static final String TARGET_FORM_FACTOR_ACTIVITY_METADATA = "com.ruiqi.product.singhome.meta.TARGET_FORM_FACTOR";
